...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <!-- Filter Form -->
        <form method="GET" action="<?php echo e(route('auditpage')); ?>" class="mb-6 flex flex-wrap gap-4 items-end">
            <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\merta\Documents\GitHub\barroc-intense\resources\views/Audit/auditpage.blade.php ENDPATH**/ ?>